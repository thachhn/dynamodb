...
internals.compileModel = function (name, schema) {
  ...
  // clinic custom
  Model.hashKey = schema.hashKey;
  Model.rangeKey = schema.rangeKey;
  Model.stripData = function(dataObj, options = {}) {
    var result = schema._modelSchema.validate(dataObj, {...options, stripUnknown: true});
